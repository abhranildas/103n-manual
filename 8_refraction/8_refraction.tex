...
\begin{figure}[htb]
\centering 
\epsfxsize=13cm \includegraphics[scale=0.6]{8_refraction/slabproc.eps}
...
\begin{figure}[htb]
\centering 
\epsfxsize=10cm \includegraphics[scale=0.5]{8_refraction/raytrace.eps}
...
\begin{figure}[htb]
\centering 
\epsfxsize=14cm \includegraphics[scale=0.4]{8_refraction/tirproc.eps}
