...
\begin{figure}[!htb]
\centering \epsfxsize=8cm \includegraphics[scale=0.5]{4_oscilloscope/sinusoid.eps}
...
\end{eqnarray*}
\begin{figure}[htb]
\centering \epsfxsize=8cm \includegraphics[scale=0.5]{4_oscilloscope/phasediffer.eps}
...
\begin{figure}[htb]
\centering \epsfxsize=8cm \includegraphics[scale=0.5]{4_oscilloscope/differfreq.eps}
...
\begin{figure}[htb]
\centering \epsfxsize=16cm \includegraphics[scale=0.7]{4_oscilloscope/tds1002d.eps}
